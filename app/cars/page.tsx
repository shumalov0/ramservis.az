...
export default function CarsPage() {
  ...
  const filteredAndSortedCars = useMemo(() => {
    ...
    const combinedFilters = {
      ...
      priceRange,
      year: year
        ? ([year, new Date().getFullYear()] as [number, number])
        : undefined,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Maşın <span className="text-brand-gold">Parkımız</span>
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Geniş maşın seçimimizdən sizə uyğun olanı tapın və rahat
              səyahətinizi təmin edin.
            </p>
          </div>
                ...
                <div className="text-center py-20">
                  <div className="max-w-md mx-auto">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                      Axtarış kriteriyalarınızı dəyişdirməyi və ya filtrləri
                      sıfırlamağı cəhd edin.
                    </p>
                    <button
